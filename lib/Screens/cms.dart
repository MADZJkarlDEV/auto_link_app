...
class _CMSPageState extends State<CMSPage> {
  ...
  Future<void> fetchPosts() async {
    final response = await http.get(Uri.parse('https://yourdomain.com/get_posts.php'));
  ...
  Future<void> fetchPublishedPosts() async {
    final response = await http.get(Uri.parse('https://yourdomain.com/get_published_posts.php'));
    if (response.statusCode == 200) {
      setState(() {
  ...
  Future<void> createPost() async {
    final request = http.MultipartRequest(
      'POST',
      Uri.parse('https://yourdomain.com/create_post.php'),
    );
  ...
  Future<void> deletePost(int postId) async {
    final response = await http.post(
      Uri.parse('https://yourdomain.com/delete_post.php'),
  ...
  Future<void> publishPost(int postId) async {
    final response = await http.post(
      Uri.parse('https://yourdomain.com/publish_post.php'),
